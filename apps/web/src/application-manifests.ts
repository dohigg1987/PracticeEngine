...
const practiceNavigation = [
  ...
  { id: "practice-clients", label: "Clients & CRM", path: "/practice/clients", icon: "clients", page: "clients" },
  ...
  { id: "practice-review", label: "Review", path: "/practice/review", icon: "document", page: "work", practiceView: "reviews", primary: false, parentId: "practice-work", group: "Delivery" },
  { id: "practice-recurring", label: "Recurring work", path: "/practice/recurring-work", icon: "document", page: "work", practiceView: "recurring", primary: false, parentId: "practice-work", group: "Delivery" },
  ...
  { id: "practice-client-portal", label: "Client portal", path: "/practice/client-portal", icon: "open", page: "client-portal", primary: false, parentId: "practice-collaboration", group: "Collaboration" },
